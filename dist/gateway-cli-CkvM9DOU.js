...
import { F as resolveDefaultModelForAgent, I as resolveHooksGmailModel, N as resolveAllowedModelRef, O as getModelRefStatus, P as resolveConfiguredModelRef, R as resolveThinkingDefault, _t as DEFAULT_MODEL, gt as DEFAULT_CONTEXT_TOKENS, k as isCliProvider, vt as DEFAULT_PROVIDER } from "./auth-profiles-DKgK9hDN.js";
...
import { r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-CsZqkYzD.js";
...
import { $ as setSkillsRemoteRegistry, $n as resolveTtsPrefsPath, $t as listAgentsForGateway, A as resolveHeartbeatVisibility, An as consumeGatewaySigusr1RestartAuthorization, At as waitForEmbeddedPiRunEnd, B as createReplyDispatcher, Bn as isSystemEventContextChanged, Bt as clearAgentRunContext, C as buildControlUiAvatarUrl, Cn as resolveSessionDeliveryTarget, Cr as resolveAgentIdentity, Ct as extractImageContentFromSource, Dn as runWithModelFallback, Dr as registerInternalHook, Dt as stopSubagentsForRequester, Er as createInternalHookEvent, Et as isAbortTrigger, Fn as normalizeCronJobPatch, Ft as detectSuspiciousPatterns, G as loadCostUsageSummary, Gn as OPENAI_TTS_MODELS, Gt as resolveAnnounceTargetFromKey, H as getCliSessionId, Hn as requestHeartbeatNow, Ht as getAgentRunContext, In as migrateLegacyCronPayload, It as getHookType, J as getRemoteSkillEligibility, Jn as isTtsEnabled, Jt as applyModelOverrideToSessionEntry, K as normalizeSendPolicy, Kn as OPENAI_TTS_VOICES, L as getChannelActivity, Lt as isExternalHookSession, M as getLastHeartbeatEvent, Mn as scheduleGatewaySigusr1Restart, Mt as registerUnhandledRejectionHandler, N as onHeartbeatEvent, Nn as setGatewaySigusr1RestartPolicy, Nt as createOpenClawTools, O as createReplyPrefixOptions, Or as triggerInternalHook, Ot as runEmbeddedPiAgent, Pn as normalizeCronJobCreate, Pt as buildSafeExternalPrompt, Q as refreshRemoteNodeBins, Qn as resolveTtsConfig, Rt as initSubagentRegistry, S as CONTROL_UI_AVATAR_PREFIX, Sn as resolveOutboundTarget, St as extractFileContentFromSource, T as resolveAssistantAvatarUrl, Tn as resetDirectoryCache, Tr as clearInternalHooks, Tt as formatZonedTimestamp, U as setCliSessionId, Ut as onAgentEvent, Vt as emitAgentEvent, W as runCliAgent, Wn as getPluginToolMeta, Wt as registerAgentRunContext, X as recordRemoteNodeInfo, Xn as resolveTtsApiKey, Y as primeRemoteSkillsCache, Yn as isTtsProviderConfigured, Yt as loadProviderUsageSummary, Z as refreshRemoteBinsForConnectedNodes, Zn as resolveTtsAutoMode, _n as ensureOutboundSessionEntry, _r as formatUserTime, _t as DEFAULT_INPUT_MAX_REDIRECTS, an as archiveFileOnDisk, ar as setCommandLaneConcurrency, at as updatePairedNodeMetadata, bt as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, cn as readSessionPreviewItemsFromTranscript, cr as stopDiagnosticHeartbeat, ct as registerSkillsChangeListener, d as handleReset, dt as parseVerboseOverride, en as listSessionsFromStore, er as resolveTtsProviderOrder, et as approveNodePairing, fn as hasNonzeroUsage, ft as DEFAULT_INPUT_FILE_MAX_BYTES, gr as normalizePollInput, gt as DEFAULT_INPUT_IMAGE_MIMES, hn as normalizeGroupActivation, ht as DEFAULT_INPUT_IMAGE_MAX_BYTES, in as resolveSessionModelRef, it as requestNodePairing, jn as isGatewaySigusr1RestartExternallyAllowed, k as buildHistoryContextFromEntries, kn as authorizeGatewaySigusr1Restart, kt as abortEmbeddedPiRun, ln as resolveSessionTranscriptCandidates, lr as isDiagnosticsEnabled, mn as clearSessionQueues, mr as stripHeartbeatToken, mt as DEFAULT_INPUT_FILE_MIMES, n as handleSlackHttpRequest, nn as loadSessionEntry, nr as setTtsProvider, nt as rejectNodePairing, on as capArrayByJsonBytes, or as CommandLane, ot as verifyNodeToken, pn as lookupContextTokens, pt as DEFAULT_INPUT_FILE_MAX_CHARS, q as resolveSendPolicy, qn as getTtsProvider, qt as loadModelCatalog, rn as resolveGatewaySessionStoreTarget, rr as textToSpeech, rt as renamePairedNode, sn as readSessionMessages, sr as startDiagnosticHeartbeat, st as getSkillsSnapshotVersion, t as loadOpenClawPlugins, tn as loadCombinedSessionStoreForGateway, tr as setTtsEnabled, tt as listNodePairing, un as stripEnvelopeFromMessages, ur as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, ut as applyVerboseOverride, vn as resolveOutboundSessionRoute, vr as resolveUserTimeFormat, vt as DEFAULT_INPUT_PDF_MAX_PAGES, w as normalizeControlUiBasePath, wt as normalizeMimeList, xt as DEFAULT_INPUT_TIMEOUT_MS, yr as resolveUserTimezone, yt as DEFAULT_INPUT_PDF_MAX_PIXELS, z as dispatchInboundMessage, zn as enqueueSystemEvent, zt as resolveAgentTimeoutMs } from "./loader--20mbAgI.js";
...
import { m as detectMime, r as saveMediaBuffer } from "./routes-BYsSaHTN.js";
import { B as normalizeVerboseLevel, H as supportsXHighThinking, I as normalizeElevatedLevel, L as normalizeReasoningLevel, M as formatThinkingLevels, N as formatXHighModelHint, R as normalizeThinkLevel, z as normalizeUsageDisplay } from "./pi-embedded-helpers-lTQOm0Sp.js";
import { a as normalizeReplyPayloadsForDelivery, t as deliverOutboundPayloads } from "./deliver-CZ9s51XS.js";
import { F as resolveExplicitAgentSessionKey, I as resolveMainSessionKey, J as expandPolicyWithPluginGroups, K as buildPluginToolGroups, L as resolveMainSessionKeyFromConfig, P as resolveAgentMainSessionKey, Q as stripPluginOnlyAllowlist, S as mergeDeliveryContext, X as normalizeToolName, Z as resolveToolProfilePolicy, b as deliveryContextFromSession, d as loadSessionStore, g as updateSessionStore, q as collectExplicitAllowlist, w as normalizeSessionDeliveryFields, z as snapshotSessionOrigin } from "./sandbox-CGhb3yKM.js";
import { m as formatUsd, p as formatTokenCount } from "./channel-summary-DFJB-feZ.js";
import { i as getMachineDisplayName, r as createBrowserRouteDispatcher } from "./wsl-BHM9IW7W.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-BM0IKqqi.js";
import { c as resolveSubagentToolPolicy, i as filterToolsByPolicy, o as resolveEffectiveToolPolicy, s as resolveGroupToolPolicy } from "./commands-QKCDDyUp.js";
...
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-Cs9H-k3F.js";
import "./daemon-runtime-BHG5CXec.js";
import "./service-DDLmNXs9.js";
import "./systemd-BatTMuQk.js";
import "./shared-D4IjBiIv.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-jBYT5djp.js";
import "./service-audit-Cabb86Ni.js";
import "./table-CIkhZk5W.js";
import { n as resolveWideAreaDiscoveryDomain, r as writeWideAreaGatewayZone } from "./widearea-dns-CwnGNpiS.js";
import { a as toOptionString, i as parsePort$1, n as extractGatewayMiskeys, r as maybeExplainGatewayServiceStop, t as describeUnknownError } from "./shared-CiO8gIf2.js";
import { i as probeGateway } from "./audit-CEiNX4FA.js";
import { _ as resolveControlUiRootSync, g as resolveControlUiRootOverrideSync, h as ensureControlUiAssetsBuilt, n as installSkill, v as discoverGatewayBeacons } from "./onboard-skills-DPHNS7xc.js";
import { c as startHeartbeatRunner, n as formatHealthChannelLines, o as runHeartbeatOnce, r as getHealthSnapshot, s as setHeartbeatsEnabled } from "./health-format-CLeRoqUc.js";
import { d as compareSemverStrings, h as DEFAULT_PACKAGE_CHANNEL, p as resolveNpmChannelTag, t as runGatewayUpdate, u as checkUpdateStatus, v as normalizeUpdateChannel } from "./update-runner-CDZoc8i4.js";
import "./github-copilot-auth-UcSIKqKw.js";
import "./logging-56YfW4V5.js";
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-Dyz0pY0O.js";
import { f as runOnboardingWizard, n as getStatusSummary, s as loadAgentIdentity, u as loadAgentIdentityFromWorkspace } from "./status-C-YMwgkE.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-zh2LneT8.js";
import "./tui-RUoSyyCB.js";
import { i as setGatewayWsLogStyle, n as logWs, r as summarizeAgentEventForWsLog, t as formatForLog } from "./ws-log-BK-b63ZP.js";
import { T as resolveGmailHookRuntimeConfig, _ as buildGogWatchServeArgs, i as ensureTailscaleEndpoint, v as buildGogWatchStartArgs } from "./gmail-setup-utils-67nY_y0-.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-BXdxmKzk.js";
import "./node-service-3V4T3lmf.js";
import "./status.update-GD0PxBy2.js";
import { n as forceFreePortAndWait } from "./ports-DE3IL0e3.js";
...
async function ensureLoaded(state, opts) {
	...
	for (const raw of jobs) {
		...
		if (schedule && typeof schedule === "object" && !Array.isArray(schedule)) {
			...
			if (!(typeof sched.kind === "string" ? sched.kind.trim().toLowerCase() : "") && ("at" in sched || "atMs" in sched)) {
				sched.kind = "at";
				mutated = true;
			}
...
async function executeJob(state, job, nowMs, opts) {
	...
	try {
		...
		if (res.status === "ok") await finish("ok", void 0, res.summary);
		else if (res.status === "skipped") await finish("skipped", void 0, res.summary);
...
const FIELD_HELP = {
	...
	"messages.lifecycleReactions": "Stage-aware emoji reactions for message processing lifecycle (replaces simple ackReaction when set).",
	"messages.lifecycleReactions.received": "Emoji when message is first received (defaults to ackReaction if set).",
	...
	"messages.lifecycleReactions.complete": "Emoji when response is complete (signals your turn to reply).",
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-BTLKBSeu.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-BSSZMVz8.js");
