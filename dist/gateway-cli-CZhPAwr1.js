import { B as normalizeThinkLevel, F as formatXHighModelHint, H as normalizeVerboseLevel, P as formatThinkingLevels, R as normalizeElevatedLevel, V as normalizeUsageDisplay, W as supportsXHighThinking, z as normalizeReasoningLevel } from "./pi-embedded-helpers-DT6rWpms.js";
import { $n as CommandLane, $t as registerUnhandledRejectionHandler, At as recordRemoteNodeInfo, B as isGatewaySigusr1RestartExternallyAllowed, Bn as getTtsProvider, Bt as verifyNodeToken, C as readSessionPreviewItemsFromTranscript, Cn as registerAgentRunContext, Cr as DEFAULT_INPUT_PDF_MAX_PAGES, D as ensureOutboundSessionEntry, Dr as extractFileContentFromSource, Dt as resolveAssistantAvatarUrl, Er as DEFAULT_INPUT_TIMEOUT_MS, Et as normalizeControlUiBasePath, Fn as createInternalHookEvent, Ft as listNodePairing, G as migrateLegacyCronPayload, Gn as resolveTtsConfig, Gt as getHookType, H as setGatewaySigusr1RestartPolicy, Hn as isTtsProviderConfigured, Ht as registerSkillsChangeListener, I as runWithModelFallback, In as registerInternalHook, It as rejectNodePairing, J as requestHeartbeatNow, Jn as setTtsEnabled, Kn as resolveTtsPrefsPath, Kt as isExternalHookSession, Ln as triggerInternalHook, Lt as renamePairedNode, M as resolveSessionDeliveryTarget, Mn as resolveUserTimeFormat, Mt as refreshRemoteNodeBins, Nn as resolveUserTimezone, Nt as setSkillsRemoteRegistry, O as resolveOutboundSessionRoute, Or as extractImageContentFromSource, Ot as getRemoteSkillEligibility, P as resetDirectoryCache, Pn as clearInternalHooks, Pt as approveNodePairing, Q as loadProviderUsageSummary, Qn as setCommandLaneConcurrency, R as authorizeGatewaySigusr1Restart, Rn as OPENAI_TTS_MODELS, Rt as requestNodePairing, S as readSessionMessages, Sn as onAgentEvent, Sr as DEFAULT_INPUT_MAX_REDIRECTS, T as stripEnvelopeFromMessages, Tn as normalizePollInput, Tr as DEFAULT_INPUT_PDF_MIN_TEXT_CHARS, Tt as buildControlUiAvatarUrl, U as normalizeCronJobCreate, Un as resolveTtsApiKey, Ut as buildSafeExternalPrompt, V as scheduleGatewaySigusr1Restart, Vn as isTtsEnabled, Vt as getSkillsSnapshotVersion, W as normalizeCronJobPatch, Wn as resolveTtsAutoMode, Wt as detectSuspiciousPatterns, X as getPluginToolMeta, Xn as textToSpeech, Xt as createReplyPrefixOptions, Yn as setTtsProvider, Z as loadOpenClawPlugins, Zt as normalizeGroupActivation, _ as loadSessionEntry, _n as initSubagentRegistry, _r as DEFAULT_INPUT_FILE_MAX_BYTES, a as loadCostUsageSummary, an as onHeartbeatEvent, b as archiveFileOnDisk, bn as emitAgentEvent, br as DEFAULT_INPUT_IMAGE_MAX_BYTES, c as clearSessionQueues, cr as lookupContextTokens, d as waitForEmbeddedPiRunEnd, dr as applyVerboseOverride, er as startDiagnosticHeartbeat, f as createOpenClawTools, fn as dispatchInboundMessage, fr as parseVerboseOverride, g as loadCombinedSessionStoreForGateway, gn as stopSubagentsForRequester, gr as loadModelCatalog, h as listSessionsFromStore, hn as isAbortTrigger, i as runCliAgent, in as getLastHeartbeatEvent, it as handleSlackHttpRequest, j as resolveOutboundTarget, jn as formatUserTime, jr as resolveAgentTimeoutMs, jt as refreshRemoteBinsForConnectedNodes, kn as resolveAgentIdentity, kr as normalizeMimeList, kt as primeRemoteSkillsCache, l as runEmbeddedPiAgent, ln as getChannelActivity, m as listAgentsForGateway, mn as formatZonedTimestamp, mr as isSystemEventContextChanged, n as getCliSessionId, nn as resolveHeartbeatVisibility, nr as isDiagnosticsEnabled, o as normalizeSendPolicy, p as resolveAnnounceTargetFromKey, pn as createReplyDispatcher, pr as enqueueSystemEvent, pt as handleReset, qn as resolveTtsProviderOrder, r as setCliSessionId, rr as DEFAULT_HEARTBEAT_ACK_MAX_CHARS, rt as hasNonzeroUsage, s as resolveSendPolicy, sr as stripHeartbeatToken, tn as buildHistoryContextFromEntries, tr as stopDiagnosticHeartbeat, u as abortEmbeddedPiRun, ur as applyModelOverrideToSessionEntry, v as resolveGatewaySessionStoreTarget, vr as DEFAULT_INPUT_FILE_MAX_CHARS, w as resolveSessionTranscriptCandidates, wr as DEFAULT_INPUT_PDF_MAX_PIXELS, wt as CONTROL_UI_AVATAR_PREFIX, x as capArrayByJsonBytes, xn as getAgentRunContext, xr as DEFAULT_INPUT_IMAGE_MIMES, y as resolveSessionModelRef, yn as clearAgentRunContext, yr as DEFAULT_INPUT_FILE_MIMES, z as consumeGatewaySigusr1RestartAuthorization, zn as OPENAI_TTS_VOICES, zt as updatePairedNodeMetadata } from "./reply-BlmcfzxV.js";
...
import { bt as DEFAULT_MODEL, c as resolveAllowedModelRef, d as resolveHooksGmailModel, i as isCliProvider, l as resolveConfiguredModelRef, p as resolveThinkingDefault, r as getModelRefStatus, u as resolveDefaultModelForAgent, xt as DEFAULT_PROVIDER, yt as DEFAULT_CONTEXT_TOKENS } from "./model-selection-CLkwGev5.js";
...
import { T as formatErrorMessage, d as inspectPortUsage, l as ensurePortAvailable, p as formatPortDiagnostics } from "./chrome-BZQheL0a.js";
import { d as hasBinary, i as loadWorkspaceSkillEntries, r as buildWorkspaceSkillSnapshot } from "./skills-C4b1FA1e.js";
import { c as saveMediaBuffer, l as detectMime } from "./routes-qdH4r5DL.js";
import "./server-context-BJ_Q7rDK.js";
import { t as rawDataToString } from "./ws-Cxo2p9fH.js";
import { f as GATEWAY_CLIENT_CAPS, g as hasGatewayClientCap, h as GATEWAY_CLIENT_NAMES, i as isGatewayMessageChannel, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES, n as isDeliverableMessageChannel, p as GATEWAY_CLIENT_IDS, r as isGatewayCliClient, s as isWebchatClient, t as INTERNAL_MESSAGE_CHANNEL } from "./message-channel-BD3kuDks.js";
...
import { a as resolveSubagentToolPolicy, i as resolveGroupToolPolicy, r as resolveEffectiveToolPolicy, t as filterToolsByPolicy } from "./pi-tools.policy-DP8RtOoM.js";
...
import { r as startBrowserControlServiceFromConfig, t as createBrowserControlContext } from "./control-service-C_HzrVwd.js";
...
import { n as resolveMessageChannelSelection } from "./channel-selection-Cmg7RpCn.js";
import { n as createOutboundSendDeps, t as createDefaultDeps } from "./deps-mgdKSoxn.js";
...
import { c as loadAgentIdentity, d as loadAgentIdentityFromWorkspace, p as forceFreePortAndWait, r as getStatusSummary, t as runOnboardingWizard } from "./onboarding-BZvYQToT.js";
...
import { d as resolveControlUiRootOverrideSync, f as resolveControlUiRootSync, i as discoverGatewayBeacons, n as installSkill, u as ensureControlUiAssetsBuilt } from "./onboard-skills-TBx8ABM4.js";
import "./github-copilot-auth-C563h2DG.js";
import "./onboard-channels-Bog0OUyk.js";
import { r as buildChannelUiCatalog, t as applyPluginAutoEnable } from "./plugin-auto-enable-0xq4IeS4.js";
import "./archive-BrH5WBhI.js";
import "./installs-W4Pc1LJz.js";
import { c as startHeartbeatRunner, n as formatHealthChannelLines, o as runHeartbeatOnce, r as getHealthSnapshot, s as setHeartbeatsEnabled } from "./health-format-CuyA1dRF.js";
import { d as compareSemverStrings, h as DEFAULT_PACKAGE_CHANNEL, p as resolveNpmChannelTag, t as runGatewayUpdate, u as checkUpdateStatus, v as normalizeUpdateChannel } from "./update-runner-MijjyzTn.js";
...
import { i as probeGateway } from "./audit-BI1DxENk.js";
...
import "./status.update-C4cZzuVz.js";
import "./completion-cli-DJE1TDKn.js";
import { a as createOutboundSendDeps$1, i as resolveAgentOutboundTarget, r as resolveAgentDeliveryPlan, t as agentCommand } from "./agent-BZHHoNnW.js";
...
import { i as shouldIncludeHook, n as loadWorkspaceHookEntries, r as resolveHookConfig } from "./hooks-status-a34fqgtQ.js";
import "./tui-CehEwo68.js";
import { t as buildChannelAccountSnapshot } from "./status-CCHBIZnm.js";
import "./shared-ChNOqAzp.js";
import { a as runDaemonStop, i as runDaemonStart, n as runDaemonStatus, o as runDaemonUninstall, r as runDaemonRestart, s as runDaemonInstall } from "./daemon-cli-CZqqGlTq.js";
...
const nodeHandlers = {
	...
	"node.event": async ({ params, respond, context, client }) => {
		...
		await respondUnavailableOnThrow(respond, async () => {
			const { handleNodeEvent } = await import("./server-node-events-pKu2oN94.js");
...
async function startBrowserControlServerIfEnabled() {
	...
	const mod = override ? await import(override) : await import("./control-service-U7Iq210p.js");
