...
import { P as resolveConfiguredModelRef, _t as DEFAULT_MODEL, gt as DEFAULT_CONTEXT_TOKENS, vt as DEFAULT_PROVIDER, y as ensureAuthProfileStore } from "./auth-profiles-DKgK9hDN.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-3xiXujG0.js";
...
import { M as VERSION, a as readConfigFileSnapshot, r as loadConfig, s as writeConfigFile } from "./config-D2YxKDFm.js";
...
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BP5bxCbS.js";
import { n as listChannelPlugins } from "./plugins-TrKFfrLt.js";
import { $t as listAgentsForGateway, J as getRemoteSkillEligibility, Sr as getMemorySearchManager, Vn as peekSystemEvents, Xt as formatUsageReportLines, Yt as loadProviderUsageSummary, _ as randomToken, a as applyWizardMetadata, b as summarizeExistingConfig, c as ensureWorkspaceAndSessions, d as handleReset, g as probeGatewayReachable, h as printWizardHeader, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, p as normalizeGatewayTokenInput, pn as lookupContextTokens, s as detectBrowserOpenSupport, v as resolveControlUiLinks, w as normalizeControlUiBasePath, x as waitForGatewayReachable } from "./loader--20mbAgI.js";
...
import { n as setupChannels } from "./onboard-channels-B--0Z9ss.js";
import { o as resolveStorePath } from "./paths-RvF0P6tQ.js";
import { I as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-CGhb3yKM.js";
import { t as buildChannelSummary } from "./channel-summary-DFJB-feZ.js";
...
import { n as installCompletion } from "./completion-cli-DqfY4zeV.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BHG5CXec.js";
import { o as resolveGatewayLogPaths, t as resolveGatewayService } from "./service-DDLmNXs9.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BatTMuQk.js";
import { o as readLastGatewayErrorLine } from "./service-audit-Cabb86Ni.js";
import { t as renderTable } from "./table-CIkhZk5W.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-CEiNX4FA.js";
import { d as applyAuthChoice, h as ensureControlUiAssetsBuilt, l as resolvePreferredProviderForAuthChoice, m as promptAuthChoiceGrouped, o as applyPrimaryModel, r as promptRemoteGatewayConfig, s as promptDefaultModel, t as setupSkills, u as warnIfModelConfigLooksOff } from "./onboard-skills-DPHNS7xc.js";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-CLeRoqUc.js";
import { _ as formatUpdateChannelLabel, d as compareSemverStrings, l as ensureCompletionCacheExists, s as checkShellCompletionStatus, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-CDZoc8i4.js";
import { n as logConfigUpdated } from "./logging-56YfW4V5.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-Dyz0pY0O.js";
import { t as buildWorkspaceSkillStatus } from "./skills-status-zh2LneT8.js";
import { t as runTui } from "./tui-RUoSyyCB.js";
import { t as resolveNodeService } from "./node-service-3V4T3lmf.js";
import { i as redactSecrets, n as formatDuration$1, r as formatGatewayAuthUsed, t as formatAge$1 } from "./format-sj0fELBK.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-GD0PxBy2.js";
...
async function finalizeOnboardingWizard(options) {
	...
	if (process.platform === "linux" && systemdAvailable) {
		const { ensureSystemdUserLingerInteractive } = await import("./systemd-linger-SWFk3Ggd.js");
