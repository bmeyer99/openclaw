...
import { _ as formatUpdateChannelLabel, a as globalInstallArgs, d as compareSemverStrings, f as fetchNpmTagVersion, g as channelToNpmTag, h as DEFAULT_PACKAGE_CHANNEL, i as detectGlobalInstallManagerForRoot, l as ensureCompletionCacheExists, m as DEFAULT_GIT_CHANNEL, n as cleanupGlobalRenameDirs, o as resolveGlobalPackageRoot, p as resolveNpmChannelTag, r as detectGlobalInstallManagerByPresence, s as checkShellCompletionStatus, t as runGatewayUpdate, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-MijjyzTn.js";
import { t as renderTable } from "./table-DuNe7Qes.js";
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, t as formatUpdateAvailableHint } from "./status.update-C4cZzuVz.js";
...
async function updateCommand(opts) {
	...
	if (shouldRestart) {
		...
		try {
			const { runDaemonRestart } = await import("./daemon-cli-D4iwND7S.js");
			...
			if (!opts.json && restarted) {
				...
				try {
					const { doctorCommand } = await import("./doctor-BSKrT8bu.js");
