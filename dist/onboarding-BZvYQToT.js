import { $ as formatUsageReportLines, Ct as waitForGatewayReachable, Et as normalizeControlUiBasePath, On as getMemorySearchManager, Ot as getRemoteSkillEligibility, Q as loadProviderUsageSummary, St as summarizeExistingConfig, _t as printWizardHeader, bt as resolveControlUiLinks, cr as lookupContextTokens, dt as formatControlUiSshHint, gt as openUrl, hr as peekSystemEvents, ht as normalizeGatewayTokenInput, lt as detectBrowserOpenSupport, m as listAgentsForGateway, ot as DEFAULT_WORKSPACE, pt as handleReset, st as applyWizardMetadata, ut as ensureWorkspaceAndSessions, vt as probeGatewayReachable, yt as randomToken } from "./reply-BlmcfzxV.js";
...
import { bt as DEFAULT_MODEL, l as resolveConfiguredModelRef, lt as ensureAuthProfileStore, xt as DEFAULT_PROVIDER, yt as DEFAULT_CONTEXT_TOKENS } from "./model-selection-CLkwGev5.js";
import { r as resolveCliName, t as formatCliCommand } from "./command-format-BQK1OIvH.js";
import { M as VERSION, a as readConfigFileSnapshot, r as loadConfig, s as writeConfigFile } from "./config-O5yyJTBQ.js";
import { n as listChannelPlugins } from "./plugins-D1CxUobm.js";
import { L as resolveMainSessionKey, d as loadSessionStore } from "./sandbox-DfObM-3h.js";
import { d as inspectPortUsage, f as resolveLsofCommandSync, p as formatPortDiagnostics } from "./chrome-BZQheL0a.js";
import { o as resolveStorePath } from "./paths-50eo6DV6.js";
import { t as buildChannelSummary } from "./channel-summary-Dj5jW3A1.js";
import { n as callGateway, t as buildGatewayConnectionDetails } from "./call-BSsife63.js";
...
import { c as promptDefaultModel, h as applyAuthChoice, m as warnIfModelConfigLooksOff, p as resolvePreferredProviderForAuthChoice, r as promptRemoteGatewayConfig, s as applyPrimaryModel, t as setupSkills, u as ensureControlUiAssetsBuilt, v as promptAuthChoiceGrouped } from "./onboard-skills-TBx8ABM4.js";
import { n as setupChannels } from "./onboard-channels-Bog0OUyk.js";
import { a as resolveHeartbeatSummaryForAgent, i as healthCommand, n as formatHealthChannelLines, t as formatHealthCheckFailure } from "./health-format-CuyA1dRF.js";
import { _ as formatUpdateChannelLabel, d as compareSemverStrings, l as ensureCompletionCacheExists, s as checkShellCompletionStatus, u as checkUpdateStatus, v as normalizeUpdateChannel, y as resolveEffectiveUpdateChannel } from "./update-runner-MijjyzTn.js";
import { i as probeGateway, t as runSecurityAudit } from "./audit-BI1DxENk.js";
...
import { o as readLastGatewayErrorLine } from "./service-audit-PX1lYqc_.js";
...
import { i as resolveUpdateAvailability, n as formatUpdateOneLiner, r as getUpdateCheckResult, t as formatUpdateAvailableHint } from "./status.update-C4cZzuVz.js";
import { n as installCompletion } from "./completion-cli-DJE1TDKn.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, n as GATEWAY_DAEMON_RUNTIME_OPTIONS, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-xaz0weRM.js";
import { t as buildWorkspaceHookStatus } from "./hooks-status-a34fqgtQ.js";
import { t as runTui } from "./tui-CehEwo68.js";
