...
import { C as resolveAuthStorePath, P as resolveConfiguredModelRef, _t as DEFAULT_MODEL, at as resolveEnvApiKey, gt as DEFAULT_CONTEXT_TOKENS, j as normalizeProviderId, s as resolveApiKeyForProfile, t as resolveAuthProfileOrder, v as upsertAuthProfile, vt as DEFAULT_PROVIDER, y as ensureAuthProfileStore } from "./auth-profiles-DKgK9hDN.js";
...
import { a as readConfigFileSnapshot, h as parseDurationMs, n as createConfigIO, r as loadConfig, s as writeConfigFile } from "./config-D2YxKDFm.js";
import { n as movePathToTrash } from "./server-context-CM_E6wD5.js";
import { n as callGateway, r as randomIdempotencyKey } from "./call-BP5bxCbS.js";
import { h as GATEWAY_CLIENT_NAMES, l as normalizeMessageChannel, m as GATEWAY_CLIENT_MODES } from "./message-channel-Csfn34Sf.js";
...
import { D as runMemoryStatus, E as registerMemoryCli, En as CHANNEL_MESSAGE_ACTION_NAMES, Ln as CHANNEL_TARGETS_DESCRIPTION, Rn as CHANNEL_TARGET_DESCRIPTION, _ as randomToken, a as applyWizardMetadata, c as ensureWorkspaceAndSessions, d as handleReset, dn as resolveCommitHash, f as moveToTrash, gn as runMessageAction, i as DEFAULT_WORKSPACE, l as formatControlUiSshHint, m as openUrl, pn as lookupContextTokens, s as detectBrowserOpenSupport, v as resolveControlUiLinks, wn as formatTargetDisplay, x as waitForGatewayReachable } from "./loader--20mbAgI.js";
...
import { d as loadSessionStore } from "./sandbox-CGhb3yKM.js";
import { r as runCommandWithRuntime } from "./cli-utils-DFbPmfWB.js";
import { n as ensurePluginRegistryLoaded, t as hasExplicitOptions } from "./command-options-D7kre5yC.js";
import { a as getFlagValue, c as getVerboseFlag, l as hasFlag, o as getPositiveIntFlagValue, r as registerSubCliCommands } from "./register.subclis-Dd04ACbv.js";
import { n as parsePositiveIntOrUndefined, t as collectOption } from "./helpers-uGhPZ_kK.js";
import { n as callGatewayFromCli, t as addGatewayClientOptions } from "./gateway-rpc-C_u_Bd8V.js";
import { t as createDefaultDeps } from "./deps-Cs9H-k3F.js";
import { a as gatewayInstallErrorHint, i as buildGatewayInstallPlan, r as isGatewayDaemonRuntime, t as DEFAULT_GATEWAY_DAEMON_RUNTIME } from "./daemon-runtime-BHG5CXec.js";
import { t as assertSupportedRuntime } from "./runtime-guard-DkjmhnBD.js";
import { t as resolveGatewayService } from "./service-DDLmNXs9.js";
import { r as isSystemdUserServiceAvailable } from "./systemd-BatTMuQk.js";
import { t as renderTable } from "./table-CIkhZk5W.js";
import { d as applyAuthChoice, f as upsertSharedEnvVar, m as promptAuthChoiceGrouped, p as applyGoogleGeminiModelDefault, u as warnIfModelConfigLooksOff } from "./onboard-skills-DPHNS7xc.js";
import { i as healthCommand } from "./health-format-CLeRoqUc.js";
import { $ as setVeniceApiKey, C as applyMoonshotConfig, D as applyOpenrouterConfig, F as applyXiaomiConfig, G as setCloudflareAiGatewayConfig, J as setMinimaxApiKey, K as setGeminiApiKey, L as applyZaiConfig, N as applyVercelAiGatewayConfig, Q as setSyntheticApiKey, W as setAnthropicApiKey, X as setOpencodeZenApiKey, Y as setMoonshotApiKey, Z as setOpenrouterApiKey, at as validateAnthropicSetupToken, et as setVercelAiGatewayApiKey, f as applyOpencodeZenConfig, g as applyMinimaxConfig, it as buildTokenProfileId, j as applyVeniceConfig, k as applySyntheticConfig, m as applyMinimaxApiConfig, nt as setZaiApiKey, q as setKimiCodingApiKey, tt as setXiaomiApiKey, v as applyAuthProfileConfig, w as applyMoonshotConfigCn, x as applyKimiCodeConfig, y as applyCloudflareAiGatewayConfig } from "./github-copilot-auth-UcSIKqKw.js";
import { n as logConfigUpdated, t as formatConfigPath } from "./logging-56YfW4V5.js";
import { a as findAgentEntryIndex, c as pruneAgentConfig, d as parseIdentityMarkdown, f as runOnboardingWizard, i as buildAgentSummaries, l as identityHasValues, o as listAgentEntries, r as applyAgentConfig, s as loadAgentIdentity, t as statusCommand } from "./status-C-YMwgkE.js";
import { a as createOutboundSendDeps, n as resolveSessionKeyForRequest, t as agentCommand } from "./agent-BXdxmKzk.js";
import { t as formatHelpExamples } from "./help-format-GuCWws6r.js";
import { a as CONFIGURE_WIZARD_SECTIONS, n as configureCommandWithSections, t as configureCommand } from "./configure-E0G0AjLD.js";
import { n as ensureSystemdUserLingerNonInteractive } from "./systemd-linger-C0UIEsx9.js";
import { n as loadAndMaybeMigrateDoctorConfig, t as doctorCommand } from "./doctor-CUr6v-pZ.js";
...
function registerConfigCli(program) {
	const cmd = program.command("config").description("Config helpers (get/set/unset). Run without subcommand for the wizard.").addHelpText("after", () => `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/config", "docs.openclaw.ai/cli/config")}\n`).option("--section <section>", "Configure wizard sections (repeatable). Use with no subcommand.", (value, previous) => [...previous, value], []).action(async (opts) => {
		const { CONFIGURE_WIZARD_SECTIONS, configureCommand, configureCommandWithSections } = await import("./configure-kcRkMb_o.js");
